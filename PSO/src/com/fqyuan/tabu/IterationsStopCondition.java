...
/**
 * Simple implementation of {@link StopCondition} that limits the amount of
...
public class IterationsStopCondition implements StopCondition {
	 ...
	 * 
	 * @param maxIterations
	 *            the amount of allowed iterations
	 */
	...
	/**
	 * Check if the current iteration is gte than the given
	 * {@code maxIterations}
	 */
	@Override
