...
public interface TabuList extends Iterable<Solution> {
	 ...
	 * @return true if the given solution is contained by this tabu, false
	 *         otherwise
	 */
	 ...
	 * This method should be implemented only by dynamic sized tabu lists, and
	 * may be called after each iteration of the algorithm
	 * 
