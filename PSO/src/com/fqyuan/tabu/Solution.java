 ...
 * Subclasses must use the objective function to calculate the value of the
 * objects of this interface, while the neighbors generations also must be
 * performed here.<br>
 * The {@link #equals()} and {@link #hashCode()} methods must be overridden to
 * ensure the algorithm correctness.
 * 
